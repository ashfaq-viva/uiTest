...
// import { TestPage } from '../../pages/try/TestPage.js'; //provide correct import path
...
import { MainHeroStyles } from '../utils/cssProperties/testStyles.js'; //provide correct import path
    ...
    if (!process.env.CI && fs.existsSync(reportPath)) {
      const openCmd =
        process.platform === 'win32'
          ...
          ? `open "${reportPath}"`
          : `xdg-open "${reportPath}"`;
    //   await new Promise(resolve => exec(openCmd, () => resolve(true)));
