...
export function compareScreenshots({
  ...
  diffPath,
  expectedCopyPath,
  threshold = 0.1 // 👈 default threshold added here
}) {
...
// Create a folder name 'manu' where store the screenshot like with naming 'mainDesktop-actual.png'
//in test file use in this way
// import { compareManualScreenshots } from '../../utils/compareScreenShots.js';
