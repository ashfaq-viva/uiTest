...
// utils/disableLazyRender.js

/**
 * Disable common WordPress lazy-loading patterns on the client
 * and eagerly load media before taking screenshots.
 *
 * Usage: await disableLazyRender(page);
 */
// lazy-fix.js
